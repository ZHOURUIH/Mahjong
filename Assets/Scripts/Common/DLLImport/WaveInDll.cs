...
public class WaveInDll
{
	public static int waveInGetNumDevs()
	{
		waveInGetNumDevsDelegate d = DllImportExtern.Invoke(DllImportExtern.WINMM_DLL, "waveInGetNumDevs", typeof(waveInGetNumDevsDelegate)) as waveInGetNumDevsDelegate;
		return d();
	}
	public static int waveInAddBuffer(IntPtr hwi, ref WaveHdr pwh, int cbwh)
	{
		waveInAddBufferDelegate d = DllImportExtern.Invoke(DllImportExtern.WINMM_DLL, "waveInAddBuffer", typeof(waveInAddBufferDelegate)) as waveInAddBufferDelegate;
		return d(hwi, ref pwh, cbwh);
	}
	public static int waveInClose(IntPtr hwi)
	{
		waveInCloseDelegate d = DllImportExtern.Invoke(DllImportExtern.WINMM_DLL, "waveInClose", typeof(waveInCloseDelegate)) as waveInCloseDelegate;
		return d(hwi);
	}
	...
	{
		waveInPrepareHeaderDelegate d = DllImportExtern.Invoke(DllImportExtern.WINMM_DLL, "waveInPrepareHeader", typeof(waveInPrepareHeaderDelegate)) as waveInPrepareHeaderDelegate;
	...
	{
		waveInUnprepareHeaderDelegate d = DllImportExtern.Invoke(DllImportExtern.WINMM_DLL, "waveInUnprepareHeader", typeof(waveInUnprepareHeaderDelegate)) as waveInUnprepareHeaderDelegate;
		return d(hWaveIn, ref lpWaveInHdr, uSize);
	}
	public static int waveInReset(IntPtr hwi)
	{
		waveInResetDelegate d = DllImportExtern.Invoke(DllImportExtern.WINMM_DLL, "waveInReset", typeof(waveInResetDelegate)) as waveInResetDelegate;
		return d(hwi);
	}
	public static int waveInStart(IntPtr hwi)
	{
		waveInStartDelegate d = DllImportExtern.Invoke(DllImportExtern.WINMM_DLL, "waveInStart", typeof(waveInStartDelegate)) as waveInStartDelegate;
		return d(hwi);
	}
	...
	{
		waveInGetDevCapsADelegate d = DllImportExtern.Invoke(DllImportExtern.WINMM_DLL, "waveInGetDevCapsA", typeof(waveInGetDevCapsADelegate)) as waveInGetDevCapsADelegate;
