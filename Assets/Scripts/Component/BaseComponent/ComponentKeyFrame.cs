...
public class ComponentKeyFrame : GameComponent
{
	...
	public ComponentKeyFrame(Type type, string name)
		:
		base(type, name)
	{
		clearCallback();
	...
	public static void setCallback(KeyFrameCallback callback, object userData, ref KeyFrameCallback curCallback, ref object curUserData, ComponentKeyFrame component)
	{
