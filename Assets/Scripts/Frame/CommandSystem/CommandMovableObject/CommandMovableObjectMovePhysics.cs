...
public class CommandMovableObjectMovePhysics : Command
{
	public string mName;
	...
	public override void execute()
	{
		...
		MovableObjectComponentMovePhysics component = obj.getFirstComponent<MovableObjectComponentMovePhysics>();
		if (component != null)
		{
