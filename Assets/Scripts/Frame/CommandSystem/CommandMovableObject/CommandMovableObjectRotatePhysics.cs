...
public class CommandMovableObjectRotatePhysics : Command
{
	public string mName;
	...
	public override void execute()
	{
		...
		MovableObjectComponentRotatePhysics component = window.getFirstComponent<MovableObjectComponentRotatePhysics>();
		if (component != null)
		{
