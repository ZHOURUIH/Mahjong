...
public class CommandMovableObjectRotateSpeed : Command
{
	...
	public override void execute()
	{
		...
		MovableObjectComponentRotateSpeed component = obj.getFirstComponent<MovableObjectComponentRotateSpeed>();
		if (component != null)
		{
